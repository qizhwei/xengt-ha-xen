...
#line 57 "libxlu_cfg_y.y" /* yacc.c:1646  */
    { xlu__cfg_set_store(ctx,(yyvsp[-2].string),(yyvsp[0].setting),(yylsp[0]).first_line); }
#line 1394 "libxlu_cfg_y.c" /* yacc.c:1646  */
    break;

  case 12:
#line 62 "libxlu_cfg_y.y" /* yacc.c:1646  */
    { (yyval.setting)= xlu__cfg_set_mk(ctx,1,(yyvsp[0].string)); }
#line 1400 "libxlu_cfg_y.c" /* yacc.c:1646  */
    break;

  case 13:
#line 63 "libxlu_cfg_y.y" /* yacc.c:1646  */
    { (yyval.setting)= (yyvsp[-1].setting); }
